...
const courseMaterialSchema = new mongoose.Schema(
  {
    ...
    fileType: { type: String, enum: ["pdf", "ppt", "video", "link", "doc", "slides", "infographic_static", "infographic_animated", "assessment", "quiz", "assignment", "live_project", "live_class", "other"], default: "other" },
